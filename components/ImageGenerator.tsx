  ...
  return (
    <div className="space-y-8">
      <form onSubmit={handleSubmit} className="p-6 bg-gray-800/50 rounded-lg border border-gray-700 space-y-4">
        <div>
          <label htmlFor="prompt-gen" className="block text-sm font-medium text-gray-300 mb-2">Image Description</label>
          <textarea
            id="prompt-gen"
            value={prompt}
      ...
      <div className="flex justify-center items-center p-6 bg-gray-800/50 rounded-lg border border-gray-700 min-h-[400px]">
        {isLoading && <div className="text-center text-gray-400 flex flex-col items-center gap-4"><Spinner /><span>Generating your image... This might take a moment.</span></div>}
